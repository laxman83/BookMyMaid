...
class BabyCare extends React.Component {
  ...
  // There is nothing which gives peace of mind to working
  // moms than having a more responsible baby care to look
  // after their kids with utmost care.
  // <br />
  // In such scenarios, hiring a baby care from a trusted
  // service will provide great relief from the awful feel of
  // being away from the baby. You can check for wonderful
  // babysitters from our portal, who are extremely willing,
  // hold experience and certainly ready to work for you. We
  // will render you a list of all babysitters with high-end
  // employment history. You can also search for the baby
  // sitters services who are highly skilled in baby care.
  // They will make your children to get exposed to new
  // talents as well as concepts. We will source you the
  // babysitters who possess extraordinary child care skills.
  //                       <Card>
  //                         <img
